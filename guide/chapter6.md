...
## Objectives
The effort to scale pilots usually takes the form of implementing the lessons learned from the first pilot into the design of a cluster of additional pilots in other areas of the client country. As a result, the bottom-up processes of OpenDRI require hiring more personnel of the same type as the pilot, while gradually handing project management over to a specific ministry (or a governance structure designed by the Open Data Working Group?). The top-down processes usually require  building the policy and management framework to curate 
...
Scaling from Pedang to Jakarta

### Pedang project with AIFDR
Mapping Pedang with OpenStreetMap

### Mapping Jakarta
Partnership from Governor to Ward Chiefs
CoMapping
Discovery of BIG: ward chief sign off = ability to release Admin 4 boundaries
BNBP desire to map all of the western coast of Indonesia with OpenStreetMap

### BIG Policy on Community Mapping Data
#### Geographic Accuracy of Features. 
The problem of projections

#### Schema and Attribute Accuracy
geometric accuracy of road is not the same as attribute accuracy. Might call a secondary road a main road because that is the perception of the community, as opposed to a national standard.

#### Technical Mapping Capacities of Participatory Mapping Projects
