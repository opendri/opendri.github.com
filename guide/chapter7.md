...
## Outputs
The most important output from OpenDRI is a changed approach to risk management. When politics, practices, and tools reflect the impact of OpenDRI on a society's thinking about DRM, the initiative has been a success&mdash;even when the specific tactics or projects with which OpenDRI began have ceased. 
