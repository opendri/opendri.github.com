...
1. **Open Government Risk Data**. What data does the government collect about natural hazards, the built environment, and other risk factors? How does the government collate, coordinate, and analyze this data? How si this data made available to other parts of the public and private sectors?
...
In most countries, it will not be possible to complete the cycle. In countries with sufficient data, the scoping mission team can work with the ministries to develop customized training programs oriented at connecting them with more advanced risk analysis.

GFDRR is developing a diagnostic tool to aid in understanding the readiness of a client country for OpenDRI, focused on assessing each component of the risk analysis process.
